<?php
/*
Template Name: Page with Simple Footer
*/
/**
...
<?php ##get_footer();
 ?>
		...
		<div class="widget-area" style="width:450px; margin: 0 auto 0 auto;">
<div class="widget" style="float:left; width:auto; padding:0px; margin:0px"><h3 class="widget-title-noitalic" style="text-align:right">Program Organizer&nbsp;&nbsp;&nbsp;</h3>
</div>
